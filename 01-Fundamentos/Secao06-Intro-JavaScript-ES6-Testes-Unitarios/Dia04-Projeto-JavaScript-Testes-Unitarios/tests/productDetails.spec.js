...
describe('6 - Implemente os casos de teste para a função `productDetails`', () => {
  it('Verifica se a função `productDetails` tem o comportamento esperado', () => {
    ...
    expect(productDetails('teste', 'teste')[0].details.productId.endsWith('123')).toBe(true);
    expect(productDetails('teste', 'teste')[1].details.productId.endsWith('123')).toBe(true);
  });
});
