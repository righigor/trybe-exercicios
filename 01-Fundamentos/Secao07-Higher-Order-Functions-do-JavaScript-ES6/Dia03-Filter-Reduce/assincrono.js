...
const pares = (numbers) => numbers % 2 === 0;
const somar = (acumulador, num) => acumulador + num;
const somaPar = (array) => array.filter(pares).reduce(somar);
...
const resultado = (alunos) => alunos.map((aluno) => ({
  name: aluno.nome,
